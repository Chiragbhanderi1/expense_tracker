...
app_email = "cbhanderi666@gmail.com"
app_license = "MIT"
...
website_route_rules = [{'from_route': '/expenses/<path:app_path>', 'to_route': 'expenses'}, {'from_route': '/expenses/<path:app_path>', 'to_route': 'expenses'},]